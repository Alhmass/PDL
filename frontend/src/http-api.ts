...
export const api = {
  ...
  getImageListSimilar: (id: number, descriptor: string, nb: number): Promise<ImageType[]> => requests.get(`images/${id}/similar`, {URLSearchParams: {number: nb, descriptor: descriptor}})
};